    ...
    return (
        <header className="headerStyle" id="idHeader">
            ...
            <div className="headerNameImageStyle" id="idHeaderNameImage">
                <img className="headerMainIconGameStyle" id="idHeaderMainIconGame1" src="img/main_header_image_r.png" alt="ss"/>
                <h1 className="classNameHeaderH1Style" id="idHeaderH1">ПОНИ - САПЁР</h1>
                <img className="headerMainIconGameStyle" id="idHeaderMainIconGame2" src="img/main_header_image.png" alt="ss"/>
            </div>
        </header>
    );
}
